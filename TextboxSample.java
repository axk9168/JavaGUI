...
public class TextboxSample
{
   public static void main(String[] args)
   {
	   ...
	   //Setting the Alignment of Displayed Text (Default is left justified)
	   textbox.setHorizontalAlignment(JTextField.RIGHT);

	   //Setting the Font of Displayed Text (Default font size is small)
	   textbox.setFont(new Font("Consolas", Font.BOLD, 40));

	   //Setting the Value of Displayed Text
	   textbox.setText("HELLO");

	   //Adding the Textbox to Main Window (using Border Layout in this example)
